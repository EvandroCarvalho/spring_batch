...
import com.spring.batch.JobService;
import com.spring.batch.quartz.JobLauncherDetails;
...
public class BatchJobsDetailedConfiguration {
  ...
  public ApplicationContextFactory getApplicationContext() {
    return new GenericApplicationContextFactory(JobService.class);
  }
